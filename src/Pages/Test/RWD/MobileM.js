                        ...
                        >
                            ...
                            <SubContainer baseDefaultTheme={"DefaultTheme"}>
                                ...
                                <DateTimePicker
                                    ...
                                    // viewType
                                    isSearchableSystemTestComponentPage
                                    placeholder={""}
                                    value={
                                        (globalContextService.get("SystemTestComponentPage", "DateTimeRange")) ?
                                            moment(globalContextService.get("SystemTestComponentPage", "DateTimeRange"), "YYYY-MM")
                                            :
                                            moment()
                                    }
                                    onChange={(value, momentObj, OnInitial) => {
                                        if (!isEqual(value, globalContextService.get("SystemTestComponentPage", "DateTimeRange"))) {
                                            ...
                                            globalContextService.set("SystemTestComponentPage", "DateTimeRange", value);
                                            setForceUpdate(f => !f)
                                        }
                                    }}
                                        ...
                                        <Text
                                            onClick={() => {
                                                if (props.NowTab !== item) {
                                                    ...
                                                    props.GetNewsTypeExecute(true, props.NewsType[index]?.value, globalContextService.get("SystemTestComponentPage", "DateTimeRange"));
                                                }
                                            }}
