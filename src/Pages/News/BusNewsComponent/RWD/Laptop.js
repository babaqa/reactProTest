...
import { ReactComponent as NoData } from '../../../../Assets/img/BusNewsComponentPage/NoData.svg'

const LaptopBase = (props) => {

    const { APIUrl, Theme, Switch, History, Location } = useContext(Context);
    const { pages: { news: { component: { busNewsComponent: { rwd: { laptop } } } } } } = Theme;
                        ...
                        <OldTable
                            ...
                            checkboxOnChecked={
                                (checkedRowKeys, checkedRows) => {
                                    ...
                                    globalContextService.set("BusNewsComponentPage", "CheckedRowKeys", checkedRowKeys);
                                    globalContextService.set("BusNewsComponentPage", "CheckedRowsData", checkedRows);
                                }
                            }
                                ...
                                [
                                    ...
                                    },
                                    {
                                        ...
                                        render: (rowData, allRowData) => {
                                            return (
                                                <>
                                                    <BasicContainer theme={laptop.newsContentContainer}>
                                                        <Text
                                                            baseDefaultTheme={"DefaultTheme"}
                                                            onClick={() => {
                                                                modalsService.titleModal.normal({
                                                                    ...
                                                                    content: (
                                                                        <Text theme={laptop.newsContentModalText}>
                            ...
                            //sort
                            //showHeader={false}
                            data={props.data.filter(d => d.identity === '3')}
                            // data={[{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},]}
