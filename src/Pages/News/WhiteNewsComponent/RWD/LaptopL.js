...
const LaptopLBase = (props) => {
    ...
    const { pages: { news: { component: { whiteNewsComponent: { rwd: { laptopL } } } } } } = Theme;
        ...
        <>
            ...
            <BasicContainer theme={laptopL.dateTimeRangeContainer}>
                ...
                <RangeDateTimePicker
                    ...
                    placeholder={""}
                    value={
                        (globalContextService.get("WhiteNewsComponentPage", "DateTimeRange") ?
                            [moment(globalContextService.get("WhiteNewsComponentPage", "DateTimeRange")[0]), moment(globalContextService.get("WhiteNewsComponentPage", "DateTimeRange")[1])]
                            :
                            [moment('2015-06-06', "YYYY-MM-DD"), moment('2018-06-06', "YYYY-MM-DD")]
                        )
                    }
                    onChange={(value, momentObj) => {
                        if (value !== globalContextService.get("WhiteNewsComponentPage", "DateTimeRange")) {
                            globalContextService.set("WhiteNewsComponentPage", "DateTimeRange", value);
                            // setForceUpdate(f => !f)
                        }
                    }}
            ...
            >
                ...
                {props.data.filter(d => d.identity === '2').length === 0
                    ?
                    <>
                        {/* 無資料表單區容器 */}
                        < BasicContainer
                    ...
                    <>
                        <OldTable
                            ...
                            //sort
                            //showHeader={false}
                            data={props.data.filter(d => d.identity === '2')}
                            // data={[{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {},]}
