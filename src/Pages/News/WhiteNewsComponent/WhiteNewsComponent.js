...
export const WhiteNewsComponent = (props) => {
    ...
    const controllGCS = (type, payload) => {
        switch (type) {
            case "return":
                ...
                globalContextService.remove("WhiteNewsComponentPage");
                //#endregion
                ...
                Object.keys(globalContextService.get("WhiteNewsComponentPage") ?? {}).forEach((item, index) => {
                    if (item.includes("CaseList_")) {
                        globalContextService.remove("WhiteNewsComponentPage", item);
                    }
                })
                //#endregion
                //#endregion
    ...
    useEffect(() => {
        const historyUnlisten = history.listen((location, action) => {
            ...
            globalContextService.remove("WhiteNewsComponentPage", "firstUseAPIgetCarType");
        });
