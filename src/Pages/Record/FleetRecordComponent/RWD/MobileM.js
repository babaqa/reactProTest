...
const MobileMBase = (props) => {
    ...
    const { pages: { record: { fleetRecordComponent: { rwd: { mobileM } } } } } = Theme;
                ...
                <>
                    <Container>
                        <CardTable
                            ...
                            showHeader={false}
                            data={
                                (globalContextService.get("RecordPage", "OrderTime") === '1') ?
                                    props.data
                                    ...
                                    :
                                    (globalContextService.get("RecordPage", "OrderTime") === '2') ?
                                        props.data
                                            .filter(d => d.case === "共享車隊" &&
