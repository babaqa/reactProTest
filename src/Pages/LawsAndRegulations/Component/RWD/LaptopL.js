...
const LaptopLBase = (props) => {
    ...
    const { pages: { lawsAndRegulations: { component: { rwd: { laptopL } } } } } = Theme;
    ...
    return (
        <>
            {(props.NowTab === "本校法規" ? props.LawsType1 : props.LawsType2).length === 0
                ?
                <>
                    {/* 無資料表單區容器 */}
                    < BasicContainer
                ...
                <>
                    <CardTable
                        ...
                        //sort
                        showHeader={false}
                        data={props.NowTab === "本校法規" ? props.LawsType1 : props.LawsType2}
