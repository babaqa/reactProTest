...
export const BusCallCarAgain = (props) => {
    ...
    const controllGCS = (type, payload) => {
        switch (type) {
            case "return":
                ...
                //#endregion
                if (payload === "API") {
                    globalContextService.remove("BusCallCarAgainPage", "CheckedRowKeys");
                    globalContextService.remove("BusCallCarAgainPage", "CheckedRowsData");
                }
                //#endregion
                break;
            case "Add":
