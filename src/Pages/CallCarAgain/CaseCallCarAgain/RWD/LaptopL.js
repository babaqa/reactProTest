...
import { ReactComponent as Minus } from '../../../../Assets/img/CaseCallCarAgainPage/Minus.svg'
...
const LaptopLBase = (props) => {
    ...
    const { pages: { callCarAgain: { caseCallCarAgain: { rwd: { laptopL } } } } } = Theme;
    ...
    useEffect(() => {
        ...
        !isNil(props.OrderData?.fromAddr) && globalContextService.set("CaseCallCarAgainPage", "StartPos", props?.OrderData?.fromAddr); // 起點地址
        !isNil(props.OrderData?.fromAddrRemark) && globalContextService.set("CaseCallCarAgainPage", "StartPosRemarks", { value: props?.OrderData?.fromAddrRemark, label: props?.OrderData?.fromAddrRemark }); // 起點備註
        !isNil(props.OrderData?.toAddr) && globalContextService.set("CaseCallCarAgainPage", "EndPos", props?.OrderData?.toAddr); // 迄點地址
        !isNil(props.OrderData?.toAddrRemark) && globalContextService.set("CaseCallCarAgainPage", "EndPosRemarks", { value: props?.OrderData?.toAddrRemark, label: props?.OrderData?.toAddrRemark }); // 迄點備註
        !isNil(props.OrderData?.canShared) && globalContextService.set("CaseCallCarAgainPage", "CanShareEquipment", props?.OrderData?.canShared ? [1] : []); // 願意共乘
        !isNil(props.OrderData?.carCategoryName) && globalContextService.set("CaseCallCarAgainPage", "CarType", { value: props?.OrderData?.carCategoryName, label: props?.OrderData?.carCategoryName }); // 車種
        !isNil(props.OrderData?.wheelchairType) && globalContextService.set("CaseCallCarAgainPage", "Wheelchair", { value: props?.OrderData?.wheelchairType, label: props?.OrderData?.wheelchairType }); // 輪椅
        !isNil(props.OrderData?.familyWith) && globalContextService.set("CaseCallCarAgainPage", "AccompanyCounts", { value: props?.OrderData?.familyWith, label: props?.OrderData?.familyWith + "人" }); // 陪同人數
        !isNil(props.OrderData?.noticePhone) && globalContextService.set("CaseCallCarAgainPage", "SmsNumber", props?.OrderData?.noticePhone); // 簡訊號碼
    }, [props.OrderData])
    //#endregion
    ...
    const getCaseOrderAmtAPI = useCallback(() => {
        ...
        else if (valid(globalContextService.get("CaseCallCarAgainPage", "TravelTime")?.value ?? "", ["^.{1,}$"], ["請選擇乘車時間"])[1]) {
            validMsg = valid(globalContextService.get("CaseCallCarAgainPage", "TravelTime")?.value ?? "", ["^.{1,}$"], ["請選擇乘車時間"])[1]
        }
        ...
        if (validMsg === "") {
            ...
            props.GetCaseOrderAmtExecute({
                ...
                // ToAddrId:, // 不用丟
                ReservationDate: globalContextService.get("CaseCallCarAgainPage", "TravelDate") + " " + globalContextService.get("CaseCallCarAgainPage", "TravelTime")?.value, // 預約日期+預約時間	如: "2020-11-25 17:45"
            })
        }
    ...
    const formValid = useCallback(() => {
        ...
        // }
            ...
            (globalContextService.get("CaseCallCarAgainPage", "ScheduleReturnReview")?.[0] === 1)
            &&
            valid(globalContextService.get("CaseCallCarAgainPage", "ReturnTravelTime")?.value ?? "", ["^.{1,}$"], ["請選擇回程乘車時間"])[1]
        ) {
            validMsg = valid(globalContextService.get("CaseCallCarAgainPage", "ReturnTravelTime")?.value ?? "", ["^.{1,}$"], ["請選擇回程乘車時間"])[1]
        }
        else if (
            (globalContextService.get("CaseCallCarAgainPage", "ScheduleReturnReview")?.[0] === 1)
            &&
            !moment(globalContextService.get("CaseCallCarAgainPage", "ReturnTravelTime")?.value, "HH:mm").isAfter(moment(globalContextService.get("CaseCallCarAgainPage", "TravelTime")?.value, "HH:mm"))
        ) {  // !(去程時間 > 回程時間)
                ...
                >
                    ...
                    <Container>
                        ...
                        <DateTimePicker
                            ...
                            onChange={(value, momentObj) => {
                                if (value !== globalContextService.get("CaseCallCarAgainPage", "TravelDate")) {
                                    ...
                                    globalContextService.remove("CaseCallCarAgainPage", "TravelTime")
                                    globalContextService.remove("CaseCallCarAgainPage", "ReturnTravelTime")
                                    setForceUpdate(f => !f)
                                }
                            }}
                        ...
                        <NewSelector
                            ...
                            value={globalContextService.get("CaseCallCarAgainPage", "TravelTime") ?? null}
                            ...
                            options={[
                                ...tenMinTimes
                                    .filter((X) => {
                                        ...
                                        if (moment(globalContextService.get("CaseCallCarAgainPage", "TravelDate") + " " + X.value).isBefore(moment())) {
                                            return null
                                        }
                            ...
                            <Container>
                                ...
                                >
                                    ...
                                    <Container>
                                        ...
                                        <Checkbox
                                            // viewType
                                            checked={globalContextService.get("CaseCallCarAgainPage", "CanShareEquipment")}
                                            // disable
                                            topLabel={""}
                                            onChange={(e, value, onInitial) => {
                                                // console.log(value)
                                                globalContextService.set("CaseCallCarAgainPage", "CanShareEquipment", value);
                                            }}
                                        ...
                                        <Checkbox
                                            // viewType
                                            checked={globalContextService.get("CaseCallCarAgainPage", "ScheduleReturnReview")}
                                            // disable
                                            topLabel={""}
                                            onChange={(e, value, onInitial) => {
                                                if (value?.[0] === 1) {
                                                ...
                                                else if (globalContextService.get("CaseCallCarAgainPage", "ScheduleReturnReview")?.[0] === 1) {
                                        ...
                                        >
                                            ...
                                            <NewSelector
                                                ...
                                                // isMulti
                                                // hideSelectedOptions={false}
                                                value={globalContextService.get("CaseCallCarAgainPage", "ReturnTravelTime") ?? null}
                                                onChange={(e, value, OnInitial) => {
                                                    globalContextService.set("CaseCallCarAgainPage", "ReturnTravelTime", value);
                                                }}
                                    ...
                                    <Container>
                                        ...
                                        {/* 接收簡訊號碼 SmsNumber */}
                                            <TextInput
                                                ...
                                                type="text"
                                                placeholder={"請輸入手機號碼"}
                                                value={globalContextService.get("CaseCallCarAgainPage", "SmsNumber") ?? null}
                                                onChange={(e, value, onInitial) => {
                        ...
                        <NativeLineButton
                            ...
                            onClick={() => {
                                ...
                                if (validMsg !== "") {
                                    ...
                                    //有回程
                                    if (globalContextService.get("CaseCallCarAgainPage", "ScheduleReturnReview")?.[0] === 1) {
                                        // 去程
                                        props.AddOrderOfCaseUsersExecute({
                                            ...
                                            orgId: "", // 送空字串
                                            reserveDate: globalContextService.get("CaseCallCarAgainPage", "TravelDate") + " " + globalContextService.get("CaseCallCarAgainPage", "TravelTime")?.value, // 預約日期+預約時間	如: "2020-11-25 17:45",
                                            ...
                                            remark: "", // 無此欄位
                                            isBack: globalContextService.get("CaseCallCarAgainPage", "ScheduleReturnReview")?.[0] === 1 ? true : false, //我要預約回程 
                                            canShared: globalContextService.get("CaseCallCarAgainPage", "CanShareEquipment")?.[0] === 1 ? true : false, // 願意共乘
                                        ...
                                        props.AddOrderOfCaseUsersExecute({
                                            ...
                                            caseUserId: props.CaseUserId, // 長照身份id
                                            orgId: "", // 送空字串
                                            reserveDate: globalContextService.get("CaseCallCarAgainPage", "TravelDate") + " " + globalContextService.get("CaseCallCarAgainPage", "ReturnTravelTime")?.value, // 預約日期+預約回程時間	如: "2020-11-25 17:45",
                                            transOrgs: globalContextService.get("CaseCallCarAgainPage", "BUnitSort")?.map(item => item?.id), // 優先搭乘車行排序
                                            createdIdentity: globalContextService.get("CaseCallCarAgainPage", "Orderer")?.value, // 訂車人身分
