...
const LaptopLBase = (props) => {
    ...
    const { pages: { fastCallCar: { addFastCallCar: { addWhite: { rwd: { laptopL } } } } } } = Theme;
                                            ...
                                            globalContextService.get("AddWhiteFastCallCarPage", "ScheduleReturnReview")?.[0] === 1
                                                ...
                                                <>
                                                    ...
                                                    <DateTimePicker
                                                        ...
                                                        placeholder={""}
                                                        value={
                                                            (globalContextService.get("AddWhiteFastCallCarPage", "ReturnTravelTime")) ?
                                                                moment(globalContextService.get("AddWhiteFastCallCarPage", "ReturnTravelTime"), "HH:mm")
                                                                :
                                                                null
                                                        }
