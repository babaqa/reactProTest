...
export const CaseEdit = (props) => {
    ...
    const controllGCS = (type, payload) => {
        switch (type) {
            case "return":
                ...
                globalContextService.remove("CaseEditPage", "Name");
                globalContextService.remove("CaseEditPage", "Birthday");
                globalContextService.remove("CaseEditPage", "Sex");
                globalContextService.remove("CaseEditPage", "Uid");
                globalContextService.remove("CaseEditPage", "CaseNumber");
                globalContextService.remove("CaseEditPage", "BoonType");
                globalContextService.remove("CaseEditPage", "Cellphone");
                globalContextService.remove("CaseEditPage", "Telephone");
                globalContextService.remove("CaseEditPage", "CaseIdentity");
                globalContextService.remove("CaseEditPage", "QuotaKeepYM");
                globalContextService.remove("CaseEditPage", "ManagementUnit");
                globalContextService.remove("CaseEditPage", "DisabilityLevel");
                globalContextService.remove("CaseEditPage", "CaseStatus");
                globalContextService.remove("CaseEditPage", "CloseOther");
                globalContextService.remove("CaseEditPage", "County");
                globalContextService.remove("CaseEditPage", "District");
                globalContextService.remove("CaseEditPage", "Address");
                globalContextService.remove("CaseEditPage", "DriverNote");
                globalContextService.remove("CaseEditPage", "ContactName");
                globalContextService.remove("CaseEditPage", "Relationship");
                globalContextService.remove("CaseEditPage", "ContactCellphone");
                globalContextService.remove("CaseEditPage", "ContactTelephone");
                ...
                if (payload === "API") {
                    globalContextService.remove("CaseEditPage", "CheckedRowKeys");
                    globalContextService.remove("CaseEditPage", "CheckedRowsData");
                }
                //#endregion
                break;
            case "Save":
    ...
    const getClient = useCallback(async (useAPI = false) => {
        ...
        if (isUndefined(globalContextService.get("CaseEditPage", "firstUseAPIgetClient")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}users/getclient?id=${urlParams.get("userId")}`, // users/getclient?id=6717458081668177920
                ...
                .finally((res) => {
                    ...
                    globalContextService.set("CaseEditPage", "firstUseAPIgetClient", false);
                    //#endregion
                });
            //#endregion
    ...
    const getCaseUsers = useCallback(async (useAPI = false) => {
        ...
        //#region 規避左側欄收合影響組件重新渲染 (渲染即觸發的每一個API都要有，useAPI (預設) = 0、globalContextService.set 第二個參數要隨API改變)
        if (isUndefined(globalContextService.get("CaseEditPage", "firstUseAPIgetCaseUsers")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}caseusers/get?id=${urlParams.get("caseUserId")}`, // caseusers/get?id=6718179154760081408  (以長照 CaseUser table ID)
                ...
                .finally(() => {
                    //#region 規避左側欄收合影響組件重新渲染 (每一個API都要有)
                    globalContextService.set("CaseEditPage", "firstUseAPIgetCaseUsers", false);
                    //#endregion
                });
            //#endregion
    ...
    const getManagerUnit = useCallback(async (useAPI = false) => {
        ...
        //#region 規避左側欄收合影響組件重新渲染 (渲染即觸發的每一個API都要有，useAPI (預設) = 0、globalContextService.set 第二個參數要隨API改變)
        if (isUndefined(globalContextService.get("CaseEditPage", "firstUseAPIgetSubOrgs")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}check/getSubOrgs?orgId=6721883683468910592`, // check/getSubOrgs?orgId=8ccf3297-8e45-43eb-8cc1-17476538b70a 
                ...
                .finally(() => {
                    //#region 規避左側欄收合影響組件重新渲染 (每一個API都要有)
                    globalContextService.set("CaseEditPage", "firstUseAPIgetSubOrgs", false);
                    //#endregion
                });
            //#endregion
