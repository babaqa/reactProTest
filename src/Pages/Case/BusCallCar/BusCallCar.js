...
export const BusCallCar = (props) => {
    ...
    const controllGCS = (type, payload) => {
        switch (type) {
            case "return":
                ...
                //#endregion
                if (payload === "API") {
                    globalContextService.remove("BusCallCarPage", "CheckedRowKeys");
                    globalContextService.remove("BusCallCarPage", "CheckedRowsData");
                }
                //#endregion
                break;
            case "Add":
    ...
    const getAllRoute = useCallback(async (useAPI = false) => {
        ...
        if (isUndefined(globalContextService.get("BusCallCarPage", "firstUseAPIgetCarType")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}busStationLiness/load?page=1&limit=99999`, // busStationLiness/load?page=1&limit=99999              
                ...
                .finally(() => {
                    ...
                    globalContextService.set("BusCallCarPage", "firstUseAPIgetCarType", false);
                    //#endregion
                });
            //#endregion
