...
export const RuralEdit = (props) => {
    ...
    const controllGCS = (type, payload) => {
        switch (type) {
            case "return":
                ...
                globalContextService.remove("RuralEditPage", "Name");
                globalContextService.remove("RuralEditPage", "Birthday");
                globalContextService.remove("RuralEditPage", "Sex");
                globalContextService.remove("RuralEditPage", "Uid");
                globalContextService.remove("RuralEditPage", "CaseNumber");
                globalContextService.remove("RuralEditPage", "BoonType");
                globalContextService.remove("RuralEditPage", "Cellphone");
                globalContextService.remove("RuralEditPage", "Telephone");
                globalContextService.remove("RuralEditPage", "CaseIdentity");
                globalContextService.remove("RuralEditPage", "QuotaKeepYM");
                globalContextService.remove("RuralEditPage", "ManagementUnit");
                globalContextService.remove("RuralEditPage", "DisabilityLevel");
                globalContextService.remove("RuralEditPage", "CaseStatus");
                globalContextService.remove("RuralEditPage", "CloseOther");
                globalContextService.remove("RuralEditPage", "County");
                globalContextService.remove("RuralEditPage", "District");
                globalContextService.remove("RuralEditPage", "Address");
                globalContextService.remove("RuralEditPage", "DriverNote");
                globalContextService.remove("RuralEditPage", "ContactName");
                globalContextService.remove("RuralEditPage", "Relationship");
                globalContextService.remove("RuralEditPage", "ContactCellphone");
                globalContextService.remove("RuralEditPage", "ContactTelephone");
                ...
                if (payload === "API") {
                    globalContextService.remove("RuralEditPage", "CheckedRowKeys");
                    globalContextService.remove("RuralEditPage", "CheckedRowsData");
                }
                //#endregion
                break;
            case "Save":
    ...
    const getClient = useCallback(async (useAPI = false) => {
        ...
        if (isUndefined(globalContextService.get("RuralEditPage", "firstUseAPIgetClient")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}users/getclient?id=${urlParams.get("userId")}`, // users/getclient?id=6717458081668177920
                ...
                .finally((res) => {
                    ...
                    globalContextService.set("RuralEditPage", "firstUseAPIgetClient", false);
                    //#endregion
                });
            //#endregion
    ...
    const getCaseUsers = useCallback(async (useAPI = false) => {
        ...
        //#region 規避左側欄收合影響組件重新渲染 (渲染即觸發的每一個API都要有，useAPI (預設) = 0、globalContextService.set 第二個參數要隨API改變)
        if (isUndefined(globalContextService.get("RuralEditPage", "firstUseAPIgetCaseUsers")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}caseusers/get?id=${urlParams.get("caseUserId")}`, // caseusers/get?id=6718179154760081408  (以長照 CaseUser table ID)
                ...
                .finally(() => {
                    //#region 規避左側欄收合影響組件重新渲染 (每一個API都要有)
                    globalContextService.set("RuralEditPage", "firstUseAPIgetCaseUsers", false);
                    //#endregion
                });
            //#endregion
    ...
    const getManagerUnit = useCallback(async (useAPI = false) => {
        ...
        //#region 規避左側欄收合影響組件重新渲染 (渲染即觸發的每一個API都要有，useAPI (預設) = 0、globalContextService.set 第二個參數要隨API改變)
        if (isUndefined(globalContextService.get("RuralEditPage", "firstUseAPIgetSubOrgs")) || useAPI) {
            //#endregion
            ...
            fetch(`${APIUrl}check/getSubOrgs?orgId=6721883683468910592`, // check/getSubOrgs?orgId=8ccf3297-8e45-43eb-8cc1-17476538b70a 
                ...
                .finally(() => {
                    //#region 規避左側欄收合影響組件重新渲染 (每一個API都要有)
                    globalContextService.set("RuralEditPage", "firstUseAPIgetSubOrgs", false);
                    //#endregion
                });
            //#endregion
