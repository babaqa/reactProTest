...
const TabletBase = (props) => {
    ...
    const { pages: { mailService: { component: { busCallCarComponent: { rwd: { tablet } } } } } } = Theme;
    ...
    return (
        <>
            {/* 叫車頁面外層容器 */}
            <Container
                theme={tablet.callCarOutContainer}
            >
                {/* 叫車表單區域容器 */}
                <SubContainer
                ...
                >
                    ...
                    >
                        <FormRow>
                            ...
                            {/* 行程標題列 */}
                            <BasicContainer
                                theme={tablet.strokeFormTitleContainer}
                            >

                                {/* 行程 */}
                                <Text
                                    theme={tablet.strokeText}
                                >
                                    行程
                                    <Minus
                                        style={tablet.strokeMinusSvg}
                                        // onClick={(e) => {
                            ...
                            {/* 行程內容容器 */}
                            <Container
                                theme={tablet.strokeFormContainer}
                            ...
                            /> */}
                                ...
                                {/* 起點容器 */}
                                <Container
                                    theme={tablet.startPosContainer}
                                >
                                    {/* 起點 */}
                                    <Text
                                        theme={tablet.todayToDoStart}
                                    >
                                        <Start2 style={tablet.todayToDoStartSvg} />
                                        起點
                                    </Text>
                                ...
                                {/* 迄點容器 */}
                                <Container
                                    theme={tablet.endPosContainer}
                                >
                                    {/* 迄點 */}
                                    <Text
                                        theme={tablet.todayToDoEnd}
                                    >
                                        <End2 style={tablet.todayToDoEndSvg} />
                                        迄點
                                    </Text>
                                    ...
                                    >
                                        <Vector style={tablet.convertContainerIcon} />
                                                起訖點互換
                                    </NativeLineButton>
                                ...
                                {/* 搭車人數及簡訊容器 */}
                                <Container
                                    theme={tablet.numberContainer}
                                >
                                    {/* 簡訊號碼 SmsNumber */}
                                    <Text theme={tablet.formSubTitleText}>接收簡訊號碼</Text>
                                    <TextInput
                                        // topLabel={<>接收簡訊號碼</>}
                                        baseDefaultTheme={"DefaultTheme"}
                                        type="text"
                                    ...
                                    {/* 搭車人數 AccTotalCounts */}
                                    <Text theme={tablet.formSubTitleText}>搭車人數</Text>
                                    <NewSelector
                                        baseDefaultTheme={"DefaultTheme"}
                                        // topLabel={"搭車人數"}
                                        //viewType
