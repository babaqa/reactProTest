...
import { CardTable, MainPageContainer, MainPageTitleBar } from '../../../ProjectComponent';
...
import { ReactComponent as RightArrow } from '../../../Assets/img/MailServicePage/RightArrow.svg'
import { ReactComponent as GoBack } from '../../../Assets/img/MailServicePage/GoBack.svg'

const MobileMBase = (props) => {

    const { APIUrl, Theme, Switch, History, Location } = useContext(Context);
    const { pages: { mailService: { rwd: { mobileM } } } } = Theme;
                ...
                outSideTopComponent={
                    <>
                        <Container theme={mobileM.titleContainer}>
                            ...
                            <Text theme={mobileM.titleText}>{`郵務查詢`}</Text>
                        </Container>
