...
import { ReactComponent as UpCircle } from '../../../../Assets/img/CaseCallCarComponentPage/UpCircle.svg'
...
const LaptopBase = (props) => {
    ...
    const { pages: { mailService: { component: { caseCallCarComponent: { rwd: { laptop } } } } } } = Theme;
