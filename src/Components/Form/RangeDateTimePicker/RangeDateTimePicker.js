...
const { RangePicker: RangeDatePickerExtend } = DatePickerExtend;

//#region 日期選擇選單
const RangeDatePickerExtendStyle = styled(RangeDatePickerExtend).attrs((props) => ({}))`
...
const { RangePicker: RangeTimePickerExtend } = TimePickerExtend;

//#region 時間選擇選單
const RangeTimePickerExtendStyle = styled(RangeTimePickerExtend).attrs((props) => ({}))`
...
//#region 表單內的勾選框
export const RangeDateTimePickerBase = (props) => {
    ...
    useEffect(() => {
        ...
        if (isArray(props.value) && (moment.isMoment(props.value?.[0]) || moment.isMoment(props.value?.[1]))) {
            ...
            switch (props.type) {
                case "time":
                    momentParse = [moment(props.value?.[0]).format(props.format ?? "HH:mm"), moment(props.value?.[1]).format(props.format ?? "HH:mm")];
                    setViewTypeValue([moment(props.value?.[0]).format(props.format ?? "HH:mm"), moment(props.value?.[1]).format(props.format ?? "HH:mm")])
                    // setViewTypeValue(moment(props.value).format(props.format ?? "HH:mm"));
                    break;
                case "date":
                    momentParse = [moment(props.value?.[0]).format(props.format ?? "YYYY-MM-DD"), moment(props.value?.[1]).format(props.format ?? "YYYY-MM-DD")];
                    setViewTypeValue([moment(props.value?.[0]).format(props.format ?? "YYYY-MM-DD"), moment(props.value?.[1]).format(props.format ?? "YYYY-MM-DD")])
                    ...
                    break;
                case "week":
                    momentParse = [`${moment(props.value?.[0]).format(props.format ?? "YYYY")}-${moment(props.value?.[0]).week()}週`, `${moment(props.value?.[1]).format(props.format ?? "YYYY")}-${moment(props.value?.[1]).week()}週`];
                    setViewTypeValue([`${moment(props.value?.[0]).format(props.format ?? "YYYY")}-${moment(props.value?.[0]).week()}週`, `${moment(props.value?.[1]).format(props.format ?? "YYYY")}-${moment(props.value?.[1]).week()}週`])
                    ...
                    break;
                case "month":
                    momentParse = [moment(props.value?.[0]).format(props.format ?? "YYYY-MM"), moment(props.value?.[1]).format(props.format ?? "YYYY-MM")]
                    setViewTypeValue([moment(props.value?.[0]).format(props.format ?? "YYYY-MM"), moment(props.value?.[1]).format(props.format ?? "YYYY-MM")])
                    ...
                    break;
                case "quarter":
                    momentParse = [`${moment(props.value?.[0]).format(props.format ?? "YYYY")}-Q${moment(props.value?.[0]).quarter()}`, `${moment(props.value?.[1]).format(props.format ?? "YYYY")}-Q${moment(props.value?.[1]).quarter()}`]
                    setViewTypeValue([`${moment(props.value?.[0]).format(props.format ?? "YYYY")}-Q${moment(props.value?.[0]).quarter()}`, `${moment(props.value?.[1]).format(props.format ?? "YYYY")}-Q${moment(props.value?.[1]).quarter()}`])
                    ...
                    break;
                case "year":
                    momentParse = [moment(props.value?.[0]).format(props.format ?? "YYYY"), moment(props.value?.[1]).format(props.format ?? "YYYY")]
                    setViewTypeValue([moment(props.value?.[0]).format(props.format ?? "YYYY"), moment(props.value?.[1]).format(props.format ?? "YYYY")])
                            ...
                            {props.type !== "time" ?
                                <>
                                    ...
                                    < RangeDatePickerExtendStyle
                                        ...
                                        popupStyle={{ width: DateTimeContainerRefWidth, minWidth: "560px", padding: "4px 0 0" }}
                                        transitionName="" //取消動畫
...
export const RangeDateTimePicker = styled(RangeDateTimePickerBase).attrs((props) => ({}))`
